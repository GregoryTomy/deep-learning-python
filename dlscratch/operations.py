"""
The Operation class represents one of the constituent functions in the neural network.
It is the abstract representation of the individual operations used in the neural network.
"""
import numpy as np
